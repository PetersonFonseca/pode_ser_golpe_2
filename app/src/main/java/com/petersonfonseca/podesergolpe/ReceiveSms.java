...
public class ReceiveSms extends BroadcastReceiver {
    ...
    public static List<String> extractUrls(String text) {
        ...
        String urlRegex = "((?:https|http|ftp)?:\\/\\/)?([^\\/,\\s]+\\.[^\\/,\\s]+?)(?=\\/|,|\\s|$|\\?|#)(.*)";
